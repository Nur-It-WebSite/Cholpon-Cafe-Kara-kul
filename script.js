...
const menuData = [
  ...
  { id: 16, name: 'Котлеты', nameKg: 'Котлеталар', description: 'Мясные котлеты с гарниром', descriptionKg: 'Гарнир менен эт котлеталары', price: 220, image: './Меню/Котлет-ориг.webp', category: 'second', ingredients: ['Фарш', 'Лук', 'Яйцо', 'Хлеб'], ingredientsKg: ['Фарш', 'Пияз', 'Жумуртка', 'Нан'] },
  ...
  { id: 19, name: 'Зразы', nameKg: 'Зразы', description: 'Мясные зразы с начинкой', descriptionKg: 'Начинка менен эт зразы', price: 240, image: './Меню/Котлеты.webp', category: 'second', ingredients: ['Мясо', 'Картофель', 'Лук', 'Яйцо'], ingredientsKg: ['Эт', 'Картөшкө', 'Пияз', 'Жумуртка'] },
  ...
  { id: 23, name: 'Мясо по-королевски', nameKg: 'Королдук эти', description: 'Мясо по-королевски с сыром', descriptionKg: 'Сыр менен королдук эт', price: 270, image: './Меню/.webp', category: 'second', ingredients: ['Мясо', 'Сыр', 'Помидоры', 'Зелень'], ingredientsKg: ['Эт', 'Сыр', 'Помидор', 'Жашылча'] },
  // ЗАКАЗНЫЕ
